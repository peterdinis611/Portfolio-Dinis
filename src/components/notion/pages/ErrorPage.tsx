  ...
  return (
    <PageShell>
      <motion.div variants={staggerContainer} initial="hidden" animate="visible">
        <StatusPageRoot watermark={ui.notionErrorWatermark} watermarkVariant="error">
          <motion.div variants={staggerItem}>
            <StatusBackLink href="#about">{ui.notionBackHome}</StatusBackLink>
          </motion.div>

          <StatusPageIcon icon="⚠️" />
          <StatusPageTitle>{ui.notionErrorHeading}</StatusPageTitle>
          ...
          <motion.div variants={staggerItem} className="mt-4">
            <BlockCalloutRich icon="🛠️" title={ui.notionErrorTipTitle} variant="warning">
