...
const TAG_META: Array<{ match: string; color: NotionTagColor; icon?: string }> = [
  ...
  { match: 'tanstack query', color: 'red', icon: 'tanstack' },
  { match: 'tanstack start', color: 'red', icon: 'tanstack' },
  { match: 'tanstack', color: 'red', icon: 'tanstack' },
  ...
  { match: 'supabase', color: 'green', icon: 'supabase' },
  { match: 'prisma', color: 'default', icon: 'prisma' },
  { match: 'vercel', color: 'default', icon: 'vercel' },
  { match: 'vitest', color: 'yellow', icon: 'vitest' },
  { match: 'vite', color: 'purple', icon: 'vite' },
  { match: 'redis', color: 'red', icon: 'redis' },
  { match: 'zod', color: 'blue', icon: 'zod' },
